...
public enum Items
{
  ...
  SWORD0(13, 508, "Schwert-Talent", "", Types.SWORDSKILL, new Attributes(), new Attributes(), new SkillAction("<#ffffff;15;2>Das Talent, mit schwert‰hnlichen Waffen umzu-[br]<#ffffff;15;2>gehen und einen einfachen Schlag auszuf¸hren.")),
  ...
  SWORD3(10, 511, "Rundumschlag", "", Types.SWORDSKILL, new Attributes(), new Attributes(), new SkillAction("<#ffffff;15;2>Ein Rundumangriff mit groﬂem Schaden auf[br]<#ffffff;15;2>mehrere Ziele vertielt.")),
