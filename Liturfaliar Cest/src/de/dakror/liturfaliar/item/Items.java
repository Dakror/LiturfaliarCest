...
public enum Items
{
  ...
  // -- swordskills -- //
  SWORD0(13, 508, 0, 0, "Schwert-Talent", "", Types.SWORDSKILL, new Attributes(Attr.cooldown, 0.18, Attr.health, -5), new Attributes(Attr.skillpoint, 1), new SkillAction("<#ffffff;15;2>Das Talent, mit schwert‰hnlichen Waffen umzu-[br]<#ffffff;15;2>gehen und einen einfachen Schlag auszuf¸hren.", new Sword0())),
