...
public class Emoticon
{
  ...
  public void draw(Graphics2D g, Map m, Viewport v)
  {
    ...
    g.drawImage(allemoticons, m.getX() + (int) parent.getRelativePos().x + (int) (parent.getWidth() * 0.3), m.getY() + (int) parent.getRelativePos().y - size, m.getX() + (int) parent.getRelativePos().x + size + (int) (parent.getWidth() * 0.3), m.getY() + (int) parent.getRelativePos().y, frame, getType() * 32, frame + 32, getType() * 32 + 32, v.w);
