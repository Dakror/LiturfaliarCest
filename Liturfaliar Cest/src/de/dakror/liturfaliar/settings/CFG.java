...
public final class CFG
{
  ...
  public static void ccs()
  {
    ...
    for (String f : fs)
    {
      p(f + ": " + Assistant.getFolderChecksum(new File(FileManager.dir, f)));
    }
  }
