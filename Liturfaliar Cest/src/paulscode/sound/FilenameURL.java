...
/**
 * The FilenameURL class is designed to associate a String filename/identifier with a URL. Handles either case where user supplies a String path or user supplies a URL instance. <br>
 * <br>
