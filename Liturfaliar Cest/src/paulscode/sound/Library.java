...
public class Library {
  ...
  public void setLooping(String sourcename, boolean lp) {
    Source mySource = sourceMap.get(sourcename);
    if (mySource != null) mySource.setLooping(lp);
  }
  ...
  public void removeSource(String sourcename) {
    Source mySource = sourceMap.get(sourcename);
    if (mySource != null) mySource.cleanup(); // end the source, free memory
  ...
  public void fadeOut(String sourcename, FilenameURL filenameURL, long milis) {
    if (midiSourcename(sourcename)) {
      ...
      Source mySource = sourceMap.get(sourcename);
      if (mySource != null) mySource.fadeOut(filenameURL, milis);
    }
  }
  ...
  public void fadeOutIn(String sourcename, FilenameURL filenameURL, long milisOut, long milisIn) {
    if (midiSourcename(sourcename)) {
      ...
      Source mySource = sourceMap.get(sourcename);
      if (mySource != null) mySource.fadeOutIn(filenameURL, milisOut, milisIn);
    }
  }
  ...
  public boolean midiSourcename(String sourcename) {
    ...
    if (midiChannel.getSourcename() == null || sourcename.equals("")) return false;
    if (sourcename.equals(midiChannel.getSourcename())) return true;
    return false;
  }
